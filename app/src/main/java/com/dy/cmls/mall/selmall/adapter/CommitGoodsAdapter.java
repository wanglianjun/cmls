...
public class CommitGoodsAdapter    extends BaseQuickAdapter<GoodsBean, BaseViewHolder> {
    private Context context;

    public CommitGoodsAdapter(int layoutResId, List<GoodsBean> data, Context context) {
