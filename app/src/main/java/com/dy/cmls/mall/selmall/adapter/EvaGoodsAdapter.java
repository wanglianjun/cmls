...
public class EvaGoodsAdapter  extends BaseQuickAdapter<MyEvaBean, BaseViewHolder> {
    private Context context;

    public EvaGoodsAdapter(int layoutResId, List<MyEvaBean> data, Context context) {
