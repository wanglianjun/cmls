...
public class DefaultDownLoaderImpl implements DownloadListener,DownLoadResultListener {
    ...
    public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
        ...
        if (mFile != null){
            ...
            //默认串行下载.
            new RealDownLoader(new DownLoadTask(NoticationID++, url,mDownLoadResultListeners,
                    isForce, enableIndicator, mContext, mFile, contentLength, R.mipmap.ic_l)).execute();
        }
    }
