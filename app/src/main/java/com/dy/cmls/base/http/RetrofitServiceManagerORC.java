...
public class RetrofitServiceManagerORC {
    //超时时间 5s
    ...
    private RetrofitServiceManagerORC() {
        // 创建 OKHttpClient
        ...
        mRetrofit = new Retrofit.Builder().client(builder.build())
            ...
            .baseUrl(CMLSConstant.HOST_ORC)
            .build();
    }

    private static class SingletonHolder {
        private static final RetrofitServiceManagerORC INSTANCE = new RetrofitServiceManagerORC();
    }

    /**
     * 获取RetrofitServiceManager
     */
    public static RetrofitServiceManagerORC getInstance() {
