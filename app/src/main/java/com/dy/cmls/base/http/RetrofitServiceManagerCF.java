...
public class RetrofitServiceManagerCF {
    //超时时间 5s
    ...
    private RetrofitServiceManagerCF() {
        // 创建 OKHttpClient
        ...
        mRetrofit = new Retrofit.Builder().client(builder.build())
            ...
            .baseUrl(CMLSConstant.HOST_URL_CF)
            .build();
    }

    private static class SingletonHolder {
        private static final RetrofitServiceManagerCF INSTANCE = new RetrofitServiceManagerCF();
    }

    /**
     * 获取RetrofitServiceManager
     */
    public static RetrofitServiceManagerCF getInstance() {
