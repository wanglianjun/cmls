...
public class BaseSwipeActivity extends BaseActivity {
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        swipeLayout.replaceLayer(BaseSwipeActivity.this);
    }
    ...
    class SwipeLayout extends FrameLayout {
        ...
        public void replaceLayer(FragmentActivity activity) {
            leftShadow = ContextCompat.getDrawable(activity, R.mipmap.left_shadow);
        ...
        private void animateFinish(boolean withVel) {
            ...
            int tmpDuration = withVel ? ((int) (duration * (screenWidth - getContentX()) / screenWidth)) :
                    duration;
            if (tmpDuration < 100) {
                tmpDuration = 100;
            }
