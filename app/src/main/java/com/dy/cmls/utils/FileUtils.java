...
public class FileUtils {
    ...
    public static Intent getAllIntent(String param, Context context ) {
        ...
        Uri uri = FileProvider.getUriForFile(context, context.getString(R.string.provider),new File(param));
        intent.setAction(Intent.ACTION_VIEW);
        intent.setDataAndType(uri,"*/*");
        return intent;
    }
...
//        Uri uri = Uri.parse(param ).buildUpon().encodedAuthority("com.android.htmlfileprovider").scheme("content").encodedPath(param ).build();
        Intent intent = new Intent("android.intent.action.VIEW");
        intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
        Uri uri = FileProvider.getUriForFile(context, context.getString(R.string.provider),new File(param)).buildUpon().encodedAuthority("com.android.htmlfileprovider").scheme("content").encodedPath(param ).build();
        intent.setDataAndType(uri, "text/html");
        return intent;
    }
...
//        contentValues.put(MediaStore.Images.Media.DATA, param);
    ...
    public static Intent getTextFileIntent(String param, Context context){
        ...
        intent.addCategory("android.intent.category.DEFAULT");
        intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
        Uri uri2 = FileProvider.getUriForFile(context, context.getString(R.string.provider),new File(param));
        intent.setDataAndType(uri2, "text/plain");
        return intent;
    }
