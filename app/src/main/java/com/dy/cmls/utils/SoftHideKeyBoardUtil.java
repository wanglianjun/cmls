...
/**
 * Created by lcjing on 2018/11/22.
 */
...
public class SoftHideKeyBoardUtil {
    ...
    private void possiblyResizeChildOfContent() {
        ...
        //2､如果当前可用高度和原始值不一样
        if(usableHeightPrevious>0&&usableHeightNow-usableHeightPrevious>300){
            if (changedListener!=null) {
                changedListener.onKeyBoardChanged(false);
            }
        }else if(usableHeightPrevious>0&&usableHeightPrevious-usableHeightNow>300){
            if (changedListener!=null) {
                changedListener.onKeyBoardChanged(true);
            }
        }
