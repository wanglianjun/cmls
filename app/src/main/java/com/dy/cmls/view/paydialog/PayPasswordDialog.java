...
import com.dy.cmls.base.BaseDialog;
import com.dy.cmls.base.BaseDialogFragment;
import com.dy.cmls.base.BaseRecyclerViewAdapter;
...
public class PayPasswordDialog {
    ...
    private static class KeyboardAdapter extends BaseRecyclerViewAdapter<KeyboardAdapter.ViewHolder> {
        ...
        public KeyboardAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new KeyboardAdapter.ViewHolder(parent, R.layout.dialog_item_pay_password);
        }
