...
/**
 * Created by lcjing on 2018/11/8.
 */
...
public class MRatingBar extends LinearLayout {
    ...
    private ImageView getStarImageView() {
        ...
        layout.setMargins(Math.round(starPadding), Math.round(starPadding), Math.round(starPadding), Math.round(starPadding));//设置每颗星星在线性布局的间距
