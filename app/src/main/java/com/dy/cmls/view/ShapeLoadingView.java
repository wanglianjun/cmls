...
public class ShapeLoadingView extends View {
    ...
    private void init() {
        mPaint = new Paint();
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.main_green1));
        ...
        switch (mShape) {
            case SHAPE_TRIANGLE:
                if (mIsLoading) {
                    ...
                    Path path = new Path();
                    mPaint.setColor(ContextCompat.getColor(getContext(), R.color.main_blue1));
            ...
            case SHAPE_CIRCLE:
                if (mIsLoading) {
                    ...
                    path.cubicTo(relativeXFromView(0.5f + magicNumber / 2), relativeYFromView(0f),
                        relativeXFromView(1), relativeYFromView(0.5f - magicNumber / 2), relativeXFromView(1f),
                    ...
                    path.cubicTo(relativeXFromView(0.5f - magicNumber / 2), relativeXFromView(1f),
                        relativeXFromView(0), relativeYFromView(0.5f + magicNumber / 2), relativeXFromView(0f),
                        relativeYFromView(0.5f));
            ...
            case SHAPE_RECT:
                if (mIsLoading) {
                    ...
                    mPaint.setColor(ContextCompat.getColor(getContext(), R.color.main_red1));
