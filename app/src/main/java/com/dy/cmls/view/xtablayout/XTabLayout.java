package com.dy.cmls.view.xtablayout;
        ...
        post(new Runnable() {
            ...
            public void run() {
                if (dividerWidth > 0) {
                    ...
                    linearLayout.setBackgroundColor(xTabBackgroundColor);
                }
            }
        });
    }
...
//        invalidate();
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        // If we have a MeasureSpec which allows us to decide our height, try and use the start_default
        // height
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        public void onMeasure(final int origWidthMeasureSpec, final int origHeightMeasureSpec) {
            ...
            if (maxWidth > 0 && (specWidthMode == MeasureSpec.UNSPECIFIED
                ...
                if (mTabMaxWidth>=0&&mTabMaxWidth<=1073741823){
...
//                        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
    ...
    private int getTabMinWidth() {
        ...
        // Else, we'll use the start_default value
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        ...
        // We return the start_default layout params so that we don't blow up if we're given a TabItem
