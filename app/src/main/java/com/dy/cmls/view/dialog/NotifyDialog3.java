...
public class NotifyDialog3 {
    ...
    public NotifyDialog3(Context context, String title1, String title2, String textOk, String textClose,
    ...
    public void show() {
        ...
        viewLine2 = dialogView.findViewById(R.id.viewLine2);
        ...
        tvCancel.setTextColor(ContextCompat.getColor(context, R.color.app_main2));
