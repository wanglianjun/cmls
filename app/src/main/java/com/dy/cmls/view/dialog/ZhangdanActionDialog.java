...
public class ZhangdanActionDialog {
    private Dialog dialog;
    private TJCallBack tjCallBack;
    private Context context;

    public ZhangdanActionDialog(Context context, TJCallBack tjCallBack) {
...
private  DialogInterface.OnDismissListener onDismissListener;
    ...
    public void show() {
        ...
        View dialogView = LayoutInflater.from(context).inflate(R.layout.dialog_zhangdan_action, null);
        TextView tvAddCard1;
        TextView tvAddCard2;
        TextView tvAddCard3;
