...
public class ShouKuanActionDialog {
    private Dialog dialog;
    private TJCallBack tjCallBack;
    private Context context;

    public ShouKuanActionDialog(Context context, TJCallBack tjCallBack) {
    ...
    public void show() {
        ...
        View dialogView = LayoutInflater.from(context).inflate(R.layout.dialog_shoukuan_action, null);
        TextView tvAddCard1;
        TextView tvAddCard2;
